...
const WebdesignBerlin = () => {
  ...
  return (
    <div className="min-h-screen">
      <SEO
        title="Günstiges Webdesign Berlin – Professionelle Websites | oezdensweb"
        description="Webdesign in Berlin: Moderne, responsive und SEO-optimierte Websites für kleine Unternehmen und Selbstständige in Berlin. Faire Preise, persönliche Beratung."
        keywords="webdesign berlin, günstige website berlin, homepage erstellen berlin, webseite berlin, webentwicklung berlin, seo berlin"
        cities={["Berlin", "Potsdam", "Spandau", "Charlottenburg"]}
      />
      <Navigation />
        ...
        <div className="container mx-auto max-w-5xl relative z-10 px-4">
          <div className="text-center space-y-3 md:space-y-4 animate-in fade-in slide-in-from-bottom-6 duration-1000">
            ...
            <p className="text-sm sm:text-base md:text-lg lg:text-xl text-muted-foreground max-w-xs sm:max-w-md md:max-w-xl lg:max-w-2xl mx-auto leading-relaxed">
              Moderne, <strong className="text-foreground">SEO-optimierte Websites</strong> für Unternehmen in Berlin – <span className="text-primary font-semibold">faire Preise, persönliche Beratung</span>.
            </p>
...
export default WebdesignBerlin;
