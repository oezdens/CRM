...
const WebdesignNuernberg = () => {
  ...
  return (
    <div className="min-h-screen">
      <SEO
        title="Günstiges Webdesign Nürnberg – Professionelle Websites | oezdensweb"
        description="Webdesign in Nürnberg: Moderne, responsive und SEO-optimierte Websites für kleine Unternehmen und Selbstständige in Nürnberg. Faire Preise, persönliche Beratung."
        keywords="webdesign nürnberg, webdesign nuernberg, günstige website nürnberg, homepage erstellen nürnberg, seo nürnberg"
        cities={["Nürnberg", "Fürth", "Erlangen", "Bamberg"]}
      />
      <Navigation />
        ...
        <div className="container mx-auto max-w-5xl relative z-10 px-4">
          <div className="text-center space-y-3 md:space-y-4 animate-in fade-in slide-in-from-bottom-6 duration-1000">
            <h1 className="text-2xl sm:text-3xl md:text-4xl lg:text-5xl xl:text-6xl font-bold tracking-tight leading-[1.25] pb-6 md:pb-8 mb-2 md:mb-3">
              ...
              <span className="block pb-2 md:pb-3 bg-gradient-to-r from-primary via-purple-500 to-accent bg-clip-text text-transparent bg-[length:200%_auto] animate-gradient">Webdesign in Nürnberg</span>
            </h1>
            <p className="text-sm sm:text-base md:text-lg lg:text-xl text-muted-foreground max-w-xs sm:max-w-md md:max-w-xl lg:max-w-2xl mx-auto leading-relaxed">Moderne, <strong className="text-foreground">SEO-optimierte Websites</strong> für Unternehmen in Nürnberg – <span className="text-primary font-semibold">faire Preise, persönliche Beratung</span>.</p>
...
export default WebdesignNuernberg;
