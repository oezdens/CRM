...
function MountGradients() {
  ...
  return (
    <>
      ...
      {/* Decorative circles (render after mount to avoid white flash) */}
...
/**
 * Lokale Landing-Page für Heilbronn
 * Nutzt dieselben Komponenten wie die Hauptseite, aber mit
 * einzigartigem SEO-Title, Description, Keywords und einem
 * zusätzlichen lokalen Intro-Abschnitt für Google.
 */
const WebdesignHeilbronn = () => {
  ...
  return (
    <div className="min-h-screen">
      <SEO
        title="Günstiges Webdesign Heilbronn – Professionelle Websites | oezdensweb"
        description="Webdesign in Heilbronn: Moderne, responsive und SEO-optimierte Websites für kleine Unternehmen und Selbstständige in Heilbronn und Umgebung. Faire Preise, persönliche Beratung."
        keywords="webdesign heilbronn, günstige website heilbronn, homepage erstellen heilbronn, webseite heilbronn, webentwicklung heilbronn, seo heilbronn"
        cities={["Heilbronn", "Neckarsulm", "Bad Friedrichshall", "Weinsberg", "Lauffen am Neckar", "Brackenheim"]}
      />
      <Navigation />

      {/* Hero-Intro für Heilbronn – modernes, ansprechendes Design */}
      <section className="relative min-h-[100svh] flex items-center justify-center px-4 pt-32 pb-24 overflow-visible">
        ...
        {/* Decorative circles moved into MountGradients to avoid flash */}
        ...
        <div className="container mx-auto max-w-5xl relative z-10 px-4">
          <div className="text-center space-y-3 md:space-y-4 animate-in fade-in slide-in-from-bottom-6 duration-1000">
            ...
            <p className="text-sm sm:text-base md:text-lg lg:text-xl text-muted-foreground max-w-xs sm:max-w-md md:max-w-xl lg:max-w-2xl mx-auto leading-relaxed">
              ...
              Unternehmen in Heilbronn und Umgebung – 
            ...
            <div className="pt-4 flex flex-col items-center gap-2">
              ...
              <div className="flex flex-wrap justify-center gap-1.5 text-[10px] md:text-xs text-muted-foreground">
                <span className="px-1.5 md:px-2 py-0.5 md:py-1 rounded bg-muted/30">Heilbronn</span>
                <span className="px-1.5 md:px-2 py-0.5 md:py-1 rounded bg-muted/30">Neckarsulm</span>
                <span className="px-1.5 md:px-2 py-0.5 md:py-1 rounded bg-muted/30">Weinsberg</span>
                <span className="px-1.5 md:px-2 py-0.5 md:py-1 rounded bg-muted/30">Bad Friedrichshall</span>
              </div>
            </div>
          </div>
        </div>
...
export default WebdesignHeilbronn;
